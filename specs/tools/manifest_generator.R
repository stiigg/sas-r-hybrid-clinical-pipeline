...
scripts <- list.files("outputs/tlf/r/gen", pattern = "\\.R$", full.names = TRUE)
qc_scripts <- list.files("qc/r/tlf", pattern = "\\.R$", full.names = TRUE)
...
output_dir <- file.path("outputs", "tlf", "r", "output")
